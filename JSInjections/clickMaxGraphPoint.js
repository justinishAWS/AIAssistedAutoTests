...
/*
 * TODO:
 * - Currently on each graph there are two line graphs (two leaderboard datapoints)
 * - We need to ensure that the correct line graph is hovered
 * - Two potential solutions:
 *   1. We can select based on stroke - in this case (#1f77b4)
 *   2. We can click out of one we do not care about
 */
console.log(leaderBoardDataPoint);
console.log("Test: ", chart.querySelectorAll(LEADER_BOARD_DATA_POINT_SELECTOR)); // This will return the leaderboard datapoints in ascending order (lowest to highest on graph)
